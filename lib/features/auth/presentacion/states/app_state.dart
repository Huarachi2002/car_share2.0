...
class AppState with ChangeNotifier {
  ...
  // ! Obtener la ubicacion del
  // void _getUserLocation() async {
  // try {
  //   // Verifica si el usuario ha otorgado permiso para acceder a la ubicación
  //   bool isLocationServiceEnabled = await Geolocator.isLocationServiceEnabled();
  //   if (!isLocationServiceEnabled) {
  //     // El servicio de ubicación está desactivado, muestra un mensaje o realiza alguna acción apropiada
  //     return;
  //   }
  ...
  //   // Accede a los detalles de la ubicación
  //   double latitude = position.latitude;
  //   double longitude = position.longitude;

  //   // Realiza acciones adicionales con la ubicación obtenida
  //   // ...

  // } catch (e) {
  //   // Error al obtener la ubicación del usuario, muestra un mensaje de error o realiza alguna acción apropiada
...
// ! TO GET THE USERS LOCATION
  void getUserLocation() async {
    ...
    CameraPosition cameraPosition = CameraPosition(
      ...
      zoom: 16.0, // Ajusta el nivel de zoom según tus necesidades
    );
    _mapController
...
/*adding to previous value as done in encoding */
  ...
  void sendRequest(String intendedLocation) async {
    List<geocoding.Location> placemark =
